    ...
    app.constant('isMcdaStandalone', false);
        ...
        app.run(['$rootScope', '$q', '$window', '$location', '$templateCache', '$transitions', '$cookies',
            ...
            function($rootScope, $q, $window, $location, $templateCache, $transitions, $cookies,
                ...
                $templateCache.put('intermediateImport.html', require('./intermediateImport/intermediateImport.html'));
            ...
            function($stateProvider, $urlRouterProvider, $httpProvider, MCDARouteProvider) {
                ...
                $stateProvider
                    ...
                    .state('intermediate',{
                            ...
                            parent: 'dataset',
                            templateUrl: './intermediateImport/intermediateImport.html',
